...
export const dashboardEn = {
  ...
  findings: {
    ...
    siteWide: "— site-wide —",
    duplicatedAt: "Same content also at",
    nearDuplicateOf: "Near-duplicate of",
  ...
  startForm: {
    ...
    fullAudit: "Run full audit",
    fullAuditHint: "Slower — also checks image weight & external links.",
...
const dashboardUk: DeepPartial<Dashboard> = {
  ...
  findings: {
    ...
    duplicatedAt: "Такий самий вміст також за адресами",
    nearDuplicateOf: "Майже дублікат",
  ...
  startForm: {
    ...
    fullAudit: "Повний аудит",
    fullAuditHint: "Повільніше — також перевіряє вагу зображень і зовнішні посилання.",
